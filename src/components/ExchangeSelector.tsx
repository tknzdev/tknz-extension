...
export const ExchangeSelector: React.FC<ExchangeSelectorProps> = ({
  defaultExchange = 'launch.tknz.fun',
      ...
      <div className="p-4 bg-gradient-to-r from-cyber-black to-cyber-black/80">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h2 className="text-cyber-green font-terminal">Default Launchpad</h2>
          </div>
        ...
        <p className="text-cyber-green/70 text-sm mt-1 ml-8">Select preferred launchpad to view your assets</p>
      </div>
    </div>
  );
};